...
kubectl -n cloud apply -f sample-apps/
...
#### deploy GW and VS
```
kubectl -n cloud apply -f cloud-web-api-gw.yaml
kubectl -n cloud apply -f cloud-web-api-gw-vs.yaml
...
#### HTTP - Test
```
curl -H "Host: cloud.io" http://172.18.255.150
curl -H "Host: rabbit.io" http://172.18.255.150
curl -H "Host: elephant.io" http://172.18.255.150

curl -H "Host: cloud.io" http://cloud.io --resolve cloud.io:80:172.18.255.150
...
```
curl --cacert ./ca/root-ca.crt -H "Host: cloud.io" https://cloud.io:443 --resolve cloud.io:443:172.18.255.150
...
#### update GW (https)
```
kubectl -n cloud apply -f cloud-web-api-https-gw.yaml
...
0.0.0.0 8443  SNI: cloud.io Route: https.443.https.cloud-web-api-gateway.cloud
...
https.443.https.cloud-web-api-gateway.cloud     cloud.io:443     cloud.io     /*                     cloud-web-api-gw-vs.cloud
...
kubernetes://cloud-cert     Cert Chain     ACTIVE     true           f90902c72989c621114b7a5b539d415c     2024-10-27T06:26:29Z     2023-10-28T06:26:30Z
...
```
# expected 404
curl -H "Host: cloud.io" http://cloud.io --resolve cloud.io:80:172.18.255.150 -vvv
...
# expected 404
curl -H "Host: cloud.io" http://cloud.io --resolve cloud.io:80:172.18.255.150 -vvv --location --cacert ./ca/root-ca.crt --resolve cloud.io:443:172.18.255.150
